...
const cardColors = ["bulbasaur", "bulbasaur", "arcanine", "arcanine", "charizard", "charizard", "evee", "evee", "espurr", "espurr", "jigglypuff", "jigglypuff", "lucario", "lucario", "mewmewtwo", "mewmewtwo", "pikachu", "pikachu"];
        ...
        setTimeout(function () {
            ...
            if (activeCards[0].className === activeCards[1].className) {
                ...
                if (gameResult == gameLength) {
                    ...
                    alert(`Brawo Ty! Twój wynik to: ${gameTime} sekund`)
                    location.reload();
                }
            }
